...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="./index.php">Typecho</a></div>
        <div class="left_open">
    ...
    <!-- 底部开始 -->
    <div class="footer">
        <div class="copyright">Copyright ©2018 小凡梦 All Rights Reserved</div>
<div class="copyright">本后台由小凡梦基于<b><a href="http://x.xuebingsi.com/"><font color="White ">X-admin</font></b></a>开发</div>		
    </div>
    <!-- 底部结束 -->
    <script>
    //百度统计可去掉
